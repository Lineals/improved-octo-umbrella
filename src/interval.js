class Interval {
     ...
     */
    union(interval) {
        if (this.overlaps(interval) || [this.end, this.start].includes(interval.start) || [this.end, this.start].includes(interval.end))
            return [new Interval(Math.min(this.start, interval.start),
